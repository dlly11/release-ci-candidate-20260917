...
redirects = {
    ...
    "python/apps/package_a_cli/docs/examples": (
        ...
        "python-release-candidate-package-a-cli-examples",
    ),
    "python/apps/package_a_cli/docs/api": (
        "python/apps/package_a_cli/docs/index",
        "python-release-candidate-package-a-cli-api",
    ),
    ...
    "native/apps/package_a_cli/docs/examples": (
        ...
        "native-release-candidate-package-a-cli-examples",
    ),
    "native/apps/package_a_cli/docs/api": (
        "native/apps/package_a_cli/docs/index",
        "native-release-candidate-package-a-cli-version-api",
    ),
...
html_baseurl = "https://dlly11.github.io/release-ci-candidate-20260917/"
html_theme_options = {
    "source_repository": "https://github.com/dlly11/release-ci-candidate-20260917/",
    "source_branch": "main",
    "source_directory": "",
}
