...
SMOKE_CHECKS = {
    "release-candidate-core": SmokeCheck(
        "release_candidate_core",
        """
from release_candidate_core import (
    Message,
    MessageKind,
    create_message,
    normalize_name,
...
""",
    ...
    "release-candidate-package-a": SmokeCheck(
...
""",
    ...
    "release-candidate-package-b": SmokeCheck(
        "release_candidate_package_b",
        """
...
""",
    ...
    "release-candidate-package-a-cli": SmokeCheck(
        "release_candidate_package_a_cli",
        """
from release_candidate_package_a_cli.cli import build_parser
assert build_parser().parse_args(["Ada"]).name == "Ada"
""",
        commands=(
            SmokeCommand("release-candidate-package-a-cli", ("Ada",), stdout="Hello, Ada!\n"),
            SmokeCommand(
                "release-candidate-package-a-cli",
                ("Ada", "--prefix", "Welcome"),
                stdout="Welcome, Ada!\n",
            ),
            SmokeCommand(
