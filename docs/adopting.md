...
3. Create an empty GitHub repository at `dlly11/release-ci-candidate-20260917` and push
   the initial `main` branch. Do not initialize the remote with a separate README or license.
4. Enable Actions and configure documentation hosting for <https://dlly11.github.io/release-ci-candidate-20260917/>.
...
7. Run `uv run repo-tools check-github-settings --repo dlly11/release-ci-candidate-20260917`.
