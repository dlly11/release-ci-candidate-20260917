...
function(monorepo_set_version_test_definitions target)
  target_compile_definitions(
    ${target}
    PRIVATE
      RELEASE_CANDIDATE_EXPECTED_VERSION="${CMAKE_PROJECT_VERSION}"
      RELEASE_CANDIDATE_EXPECTED_VERSION_MAJOR=${CMAKE_PROJECT_VERSION_MAJOR}
      RELEASE_CANDIDATE_EXPECTED_VERSION_MINOR=${CMAKE_PROJECT_VERSION_MINOR}
      RELEASE_CANDIDATE_EXPECTED_VERSION_PATCH=${CMAKE_PROJECT_VERSION_PATCH}
  )
endfunction()
