#ifndef RELEASE_CANDIDATE_CORE_H
#define RELEASE_CANDIDATE_CORE_H
...
typedef enum release_candidate_status {
    /** The operation completed successfully. */
    RELEASE_CANDIDATE_STATUS_OK = 0,
    /** A required pointer, string, or capacity was invalid. */
    RELEASE_CANDIDATE_STATUS_INVALID_ARGUMENT = 1,
    /** The output buffer could not hold the complete formatted message. */
    RELEASE_CANDIDATE_STATUS_BUFFER_TOO_SMALL = 2,
    /** The C runtime could not format the message. */
    RELEASE_CANDIDATE_STATUS_FORMAT_ERROR = 3
